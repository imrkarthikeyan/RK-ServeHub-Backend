...
export default function Services(){
    return(
        <>
            <h2 className="pb-5 pt-10 text-[30px] px-5 text-[DodgerBlue] font-bold">Services :</h2>
            <div className="p-4 mad:p-[50px]">
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
                    <div className="hover:bg-[DodgerBlue] rounded shadow-light group transition duration-350 else-in-out">
